...
return new class extends Migration
{
    ...
    {
        Schema::create('revision_mistakes', function (Blueprint $table) {
            $table->id();
            $table->foreignId('revision_submission_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('revision_mistakes');
    }
};
